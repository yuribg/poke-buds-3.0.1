...
export class PokemonComponent implements OnInit, AfterContentInit {
  ...
  getPokemon(): Pokemon {
    ...
    this.currentPokemon.shiny = this.getShinyCondition();
    this.currentPokemon.name += (this.currentPokemon.shiny == true ? " ★" : "");
  ...
  getShinyCondition() {
    return Math.random() < this.shinyBias;
  }

  getSpriteFolderCondition() {
    return this.currentPokemon.shiny ? this.shinyFolder : this.normalFolder;
  }
}
